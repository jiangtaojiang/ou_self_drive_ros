...
class ColorExtract(object):
    ...
    def callback(self, data):
        ...
        white_area, white_image = self.get_colored_area(
            cv_image, np.array([0,0,255]), np.array([255,255,255]))
        white_image=white_image[300:400,1:640,:]
        try:
            ...
            self._white_pub.publish(self._bridge.cv2_to_imgmsg(white_image, 'bgr8'))
        except CvBridgeError, e:
            print e
